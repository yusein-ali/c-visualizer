...
export default {
  ...
  constructIf: 'if 文',
  constructFor: 'for 文',
  constructWhile: 'while 文',
  constructDoWhile: 'do-while 文',
  constructSwitch: 'switch 文',
  ...
  constructRecordField: '構造体・共用体のメンバ',
  uninitialized: '未初期化',
  declarationType: '型',
  storageClass: '記憶域クラス',
  qualifiers: '型修飾子',
  ...
  returnType: '戻り値の型',
  parameters: '仮引数',
  typedefName: 'typedef名',
  enumeration: '列挙型',
  record: '構造体・共用体',
  tag: 'タグ',
  value: '値',
  none: 'なし',
  constructFunctionDec: '関数定義',
  constructCall: '関数呼び出し',
  constructTernary: '条件演算子',
  constructCast: 'キャスト',
